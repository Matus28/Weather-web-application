...
describe('test cities routes', () => {
  ...
  test('successfully set users authentication/token', (done: jest.DoneCallback) => {
    request(app)
      .post('/api/user/login')
      .send({
        email: 'test@gmail.com',
  ...
  test('add new city Pezinok on the users city list', (done: jest.DoneCallback) => {
    request(app)
      .post('/api/cities')
  ...
  test('returns list of users cities', (done: jest.DoneCallback) => {
    request(app)
      .get('/api/cities')
      .set({ Authorization: `Bearer ${auth.token}` })
      .end((err: Error, res: Response) => {
  ...
  test('removes city from users list of cities', (done: jest.DoneCallback) => {
    request(app)
...
describe('test weather routes', () => {
  ...
  test('returns valid users auth token after login', (done: jest.DoneCallback) => {
    request(app)
      .post('/api/user/login')
      .send({
        email: 'test@gmail.com',
