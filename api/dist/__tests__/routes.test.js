    ...
    test('removes user if already exist (before creating in the next test)', (done) => {
        (0, supertest_1.default)(index_1.default)
            ...
            (0, supertest_1.default)(index_1.default)
                ...
                .end((errorGet, responseGet) => {
                if (errorGet)
                    done(errorGet);
                const exist = responseGet.body.filter((user) => user.email === 'newTest@gmail.com');
                if (exist.length > 0) {
                    (0, supertest_1.default)(index_1.default)
                        .delete('/api/user')
                        .set({ Authorization: `Bearer ${tokenAdmin}` })
...
describe('test cities routes', () => {
    ...
    test('successfully set users authentication/token', (done) => {
        (0, supertest_1.default)(index_1.default)
            .post('/api/user/login')
            .send({
            email: 'test@gmail.com',
    ...
    test('add new city Pezinok on the users city list', (done) => {
        (0, supertest_1.default)(index_1.default)
            .post('/api/cities')
    ...
    test('returns list of users cities', (done) => {
        (0, supertest_1.default)(index_1.default)
            .get('/api/cities')
            .set({ Authorization: `Bearer ${auth.token}` })
            .end((err, res) => {
    ...
    test('removes city from users list of cities', (done) => {
        (0, supertest_1.default)(index_1.default)
...
describe('test weather routes', () => {
    ...
    test('returns valid users auth token after login', (done) => {
        (0, supertest_1.default)(index_1.default)
            .post('/api/user/login')
            .send({
            email: 'test@gmail.com',
