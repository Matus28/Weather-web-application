...
const cityList = [
    {
        __v: 0,
        _id: "6449b4e509b64bc76facde6c",
        cityName: "Bratislava",
        isDefault: false,
        userId: "644958479a4d55cb522af760",
    },
    {
        __v: 0,
        _id: "644a521fcbdc852e94d12c14",
        cityName: "Kosice",
        userId: "644958479a4d55cb522af760",
        isDefault: false,
    },
...
describe("test cities routes", () => {
    ...
    test("add new city Pezinok on the user's city list", (done) => {
        (0, supertest_1.default)(index_1.default)
            ...
            (0, supertest_1.default)(index_1.default)
                ...
                const addedCity = res.body.filter((city) => city.cityName === "Pezinok")[0];
    ...
    test("returns list of user's cities", (done) => {
        (0, supertest_1.default)(index_1.default)
            ...
            expect(res.body).toEqual(cityList);
            done();
        });
    });
