...
describe("CurrentWeather component test", () => {
  ...
  test("returns elements with all data about current weather in Bratislava", () => {
    ...
    const CityName = container.getElementsByClassName(
      "current-weather__city"
    )[0].firstChild;
    const divRain = container.getElementsByClassName(
      "current-weather__rain"
    )[0];
    const divTemp = container.getElementsByClassName(
      "current-weather__temp"
    )[0];
    const divCond = container.getElementsByClassName(
  ...
  test("returns input element type of checkbox as Switch", () => {
    ...
    const inputSwitch = container.getElementsByTagName(
      "input"
  ...
  test("returns button element to add city on the list", () => {
    ...
    const buttonAdd = container.getElementsByTagName(
      "button"
