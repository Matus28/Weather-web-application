...
describe('PasswordTextField component test', () => {
  test('returns input element with all attributes defined without error message', () => {
    const { container } = render(
      <PasswordTextField value={'Test123'} name={'password'} onChange={changeHandler} />,
    )
    const inputElement = container.getElementsByTagName('input')[0] as HTMLInputElement
  ...
  test('return input element with error', () => {
    ...
    const errorMessage = container.getElementsByTagName('p')[0] as HTMLParagraphElement
  ...
  test('returns input element with icon for switching show/hide password', () => {
    ...
    const inputElement = container.getElementsByTagName('input')[0] as HTMLInputElement
    const buttonIcon = container.getElementsByTagName('button')[0] as HTMLButtonElement
