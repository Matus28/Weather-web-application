...
describe('tests AirCondition component', () => {
  test('should render element with the Title Wind speed', () => {
    const { container } = render(<AirCondition weatherData={testBAWeatherData} />)
  ...
  test('should render element with the Title Real feel', () => {
    const { container } = render(<AirCondition weatherData={testBAWeatherData} />)
    const title = container.getElementsByClassName('air-condition-element__title')[2]
  ...
  test('should render element with the Title UV Index', () => {
    const { container } = render(<AirCondition weatherData={testBAWeatherData} />)
    const title = container.getElementsByClassName('air-condition-element__title')[3]
  ...
  test('should render element with the Title Humidity', () => {
    const { container } = render(<AirCondition weatherData={testBAWeatherData} />)
    const title = container.getElementsByClassName('air-condition-element__title')[4]
