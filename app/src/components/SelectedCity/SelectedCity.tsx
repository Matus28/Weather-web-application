      ...
      <div className='selected-city-weather'>
        <div className='selected-city-weather__main'>
          ...
          <div className='selected-city-weather__temp'>
            {props.data && <h1>{`${Math.round(props.data.current.temp_c)}°C`}</h1>}
          </div>
        </div>
        ...
        <div className='selected-city-weather__today-forecast'>
          <div className='selected-city-weather__today-forecast__title'>{title}</div>
          {props.data && (
            <TodayForecastList
        ...
        <div className='selected-city-weather__three-days-forecast'>
          <div className='selected-city-weather__three-days-forecast__title'>3 day forecast</div>
          {props.data && (
            <WeekForecastList forecastData={props.data?.forecast.forecastday} days={3} />
          )}
        </div>
      </div>
    </Card>
