...
export const TodayForecastElement = (props: { forecastHour: ForecastHour }): JSX.Element => {
  const time = new Date(props.forecastHour.time).toLocaleTimeString(navigator.language, {
    hour: '2-digit',
    minute: '2-digit',
  })
