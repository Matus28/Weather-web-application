    ...
    <div className='signup'>
      <Card class='signup'>
        <form id='signup-form' className='signup' onSubmit={handleSubmit}>
          ...
          <PasswordTextField onChange={setPassword} value={password} name={'password'} />
          ...
          <BlueStyledButton variant='text' type='submit' form='signup-form' disabled={isLoading}>
            Submit
          </BlueStyledButton>
          {error ? <div className='error'>{`${error}`}</div> : <div></div>}
        </form>
        <div className='terms-and-conditions'>
          By clicking the Submit button, you agree to our <a href=''>Terms and Conditions</a> and{' '}
